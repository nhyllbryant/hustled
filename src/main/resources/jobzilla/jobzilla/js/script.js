(function($) {
  ...
  //bx slider
   ...
   ========================================================================== */
	...
	jQuery(document).on('ready', function () {
       (function ($) {
          // Add a call to the preloader here to ensure it shows immediately
          handlePreloader();
          directionswitch();
       })(jQuery);
    });
    ...
    $(window).on('load', function() {
       // Remove the call from here, as it's already running in 'ready'
       // If you keep it, it will simply run again, which is harmless but redundant
       // handlePreloader();
       enableMasonry();
       title_animation();
    });
    // Add this new block to your custom.js file
    window.addEventListener('pageshow', function (event) {
        // If the page is loaded from the BFcache (i.e., using the back/forward button)
        if (event.persisted) {
            // Re-show the preloader immediately before running the hide function
            $('.loader-wrap').show();

            // Re-run the function to start the fadeOut process
            handlePreloader();
        }
    });
